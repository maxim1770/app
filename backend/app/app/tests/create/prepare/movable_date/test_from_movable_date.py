...
TEST_MAP_CYCLE_1: list[tuple[tuple[enums.CycleNum, int, int], date_type]] = [
    ...
    (
        ...
        DATE_PASKHA + timedelta(days=1)),
    (
        (enums.CycleNum.cycle_1, 2, 0),
        DATE_PASKHA + timedelta(weeks=1)),
    (
        (enums.CycleNum.cycle_1, 2, 2),
        DATE_PASKHA + timedelta(weeks=1, days=2)),
    (
        (enums.CycleNum.cycle_1, 4, 4),
        DATE_PASKHA + timedelta(weeks=3, days=4)),
    (
        (enums.CycleNum.cycle_1, 8, 6),
        DATE_PASKHA + timedelta(weeks=7, days=6)),
]
...
TEST_MAP_CYCLE_2: list[tuple[tuple[enums.CycleNum, int, int], date_type]] = [
    (
        ...
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1)),
    (
        (enums.CycleNum.cycle_2, 1, 1),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1) + timedelta(days=1)),
    (
        (enums.CycleNum.cycle_2, 2, 0),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1) + timedelta(weeks=1)),
    (
        (enums.CycleNum.cycle_2, 2, 2),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1) + timedelta(weeks=1, days=2)),
    (
        (enums.CycleNum.cycle_2, 4, 4),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1) + timedelta(weeks=3, days=4)),
    (
        (enums.CycleNum.cycle_2, 35, 6),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1) + timedelta(weeks=34, days=6)),
    (
        (enums.CycleNum.cycle_2, 36, 0),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1) + timedelta(weeks=35, days=0)),
]
...
TEST_MAP_CYCLE_3: list[tuple[tuple[enums.CycleNum, int, int], date_type]] = [
    (
        ...
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1 + NumMovableDay.IN_CYCLE_2)),
    (
        (enums.CycleNum.cycle_3, 1, 1),
        DATE_PASKHA + timedelta(days=NumMovableDay.IN_CYCLE_1 + NumMovableDay.IN_CYCLE_2) + timedelta(
            days=1)),
    (
