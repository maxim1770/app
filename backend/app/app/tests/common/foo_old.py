...
from app.create.prepare.icon.icon import _get_icon_data_in
...
if __name__ == '__main__':
    ...
    for pravicon_icon_id in [4029, 4044, 4046, 4047, 4048, 4070, 4082, 4083, 4084, 4085, 4086, 4087, 4088, 4089, 4090,
        ...
        try:
            holiday_slug = 'foo'
            a = _get_icon_data_in(session, pravicon_icon_id=pravicon_icon_id, holiday_slug=holiday_slug)
            logging.info(a)
            logging.info(holiday_slug)
