...
def get_days(db: Session, cycle_num: int, sunday_num: int) -> list[models.Day]:
...
def get_day(db: Session, cycle_num: int, sunday_num: int, num: schemas.DayEnum) -> models.Day:
    week_id: int = get_week(db, cycle_num=cycle_num, sunday_num=sunday_num).id
...
def create_day(db: Session, cycle_num: int, sunday_num: int, day: schemas.DayCreate) -> models.Day:
    week_id: int = get_week(db, cycle_num=cycle_num, sunday_num=sunday_num).id
