...
@router.get('/{book_title_short_en}/zachalos', response_model=list[schemas.Zachalo])
...
@router.get('/{book_title_short_en}/zachalos/{zachalo_num}', response_model=schemas.Zachalo)
...
@router.post('/{book_title_short_en}/zachalos', response_model=schemas.Zachalo,
