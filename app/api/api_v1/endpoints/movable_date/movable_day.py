...
# def read_movable_days(cycle_num: schemas.CycleEnum, sunday_num: int, db: Session = Depends(deps.get_db)):
...
def read_movable_day(cycle_num: schemas.CycleEnum, sunday_num: int, movable_day_abbr: schemas.MovableDayAbbrEnum, db: Session = Depends(deps.get_db)):
...
def create_movable_day(cycle_num: schemas.CycleEnum, sunday_num: int, movable_day: schemas.MovableDayCreate, db: Session = Depends(deps.get_db)):
