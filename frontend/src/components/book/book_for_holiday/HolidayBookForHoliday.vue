<template>
  <ChapterWithHead
    v-if="holidayBooksWithoutUpominanies?.length"
    headTitle="Жития, Прологи"
  >
    <v-card
      v-for="holiday_book in holidayBooksWithoutUpominanies"
      :key="holiday_book?.id"
      class="mb-3"
    >
...
export default {
  components: {
    GalleryMain,
    ChapterWithHead,
    ListItemHolidayBookFullTitle: ListItemHolidayBookFullTitle,
    ListItemManuscript
  },
  props: {
